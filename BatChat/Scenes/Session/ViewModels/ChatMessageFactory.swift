...
class ChatMessageFactory {
    ...
    class func makeTextMessage(_ uid: String, text: String, isIncoming: Bool) -> ChatTextMessageModel {
    ...
    class func makePhotoMessage(_ uid: String, image: UIImage, size: CGSize, isIncoming: Bool) -> ChatPhotoMessageModel {
...
//    }
    ...
    private class func makeRandomTextMessage(_ uid: String, isIncoming: Bool) -> ChatTextMessageModel {
